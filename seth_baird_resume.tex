...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Verified Seller}{Aug 2021 - August 2023} 
      %may need date modification
      \resumeItemListStart
        \resumeItem{Computer Sales and Commissions}
          {Built and sold more than 15 tailored desktop, laptop, and Mac computers to end users at different price points and configurations.}
