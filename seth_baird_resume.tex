...
\section{Involvement}
  ...
  \resumeItem{Purdue Electric Racing - Software Team}
  {
    \begin{itemize}
      \vspace{-3pt}
      \item Developed code for the main module of the car alongside core members of the organization
...
\section{Programming and IT Skills}
 ...
 \begin{itemize}
  ...
  %  \item Created many interactive circuits in Lab based around the ATMEGA2560 using AVR Studio and pure C
   \item Installed a 3D printer monitoring solution using Octoprint, a camera, and a Raspberry Pi
 ...
 \begin{itemize}
   \vspace{-3pt}
   \item Worked with Java and OOP at home and in school beginning in 2018, completing multiple courses in the subject
 ...
 \end{itemize}
  ...
  \resumeItem{Linux Server Administration}
  {
    \begin{itemize}
      ...
      \item Assembled two purpose-built NAS computers with identical hardware, configured to make encrypted backups to each other over a VPN tunnel
